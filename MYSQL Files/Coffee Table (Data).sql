SHOW DATABASES;
USE coffee_store; #If the coffee database has been loaded, it can be accessed from any sql text file

INSERT INTO products(name, price, coffee_origin)
VALUES('Arabic', 4.50, 'Arabia'),
		('Espresso', 2.50, 'Brazil'),
        ('Macchiato', 3.00, 'Brazil'),
        ('Cappuccino', 2.50, 'Costa Rica');
...
SET SQL_SAFE_UPDATES = 0; #We have to turn off this feature to use another property than primary column 
UPDATE products
SET price = 4.00 #You can update two columns at once
WHERE price = 3.50; 

SELECT*FROM products; #Idk what this does, but it displays the data of the table
...
DELETE FROM people; #This line will delete all lines 
*/